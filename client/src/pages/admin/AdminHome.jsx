     ...
     <div class="my-5">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-end pt-3">
              <div className="container">
                <h4>About Yukimito</h4>
                <h1 class="display-4 fw-bold lh-1">
                  <span className="yuki-font-color">The Standards</span>
                  <br />
                  Are Higher Here
                </h1>
                <p class="lead">
                  Yukimito Pet Boarding & Hotel Service, is a pet-friendly and
                  professional service for the Illongo’s who are traveling
                  outside of their homes and won’t be able to care of their
                  furry loved ones.
                </p>
              </div>
            </div>
         ...
         <div class="row flex-lg-row align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            ...
            <h1 class="display-5 fw-bold lh-1 mb-3 yuki-font-color">
              ...
              <br />
              <span className="black-font">an incredible place.</span>
            </h1>
            <p class="lead">
              Our staff spends time interacting with and monitoring the pets to
              ensure their safety and happiness while they are with us.
              <br />
              <br />
              ...
              bottom line. Collaboratively administrate empowered markets via
          ...
          <div class="col-lg-6">
            <div class="card my-2 shadow">
              <div class="card-body lead row">
                ...
                <div className="col-11">WELL-TRAINED STAFF</div>
              </div>
            </div>
            <div class="card my-2 shadow">
              <div class="card-body lead row">
                ...
                <div className="col-11">METICULOUS ABOUT MEDS & VACCINES</div>
              </div>
            </div>
            <div class="card my-2 shadow">
              <div class="card-body lead row">
        ...
        <div class="my-5">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="card my-2 shadow">
                <div class="card-body lead row">
                  ...
                  <div className="col-11">Updated Vet Vaccine Cards</div>
                </div>
              </div>
              <div class="card my-2 shadow">
                <div class="card-body lead row">
                  ...
                  <div className="col-11">Recent Tick and Flea Treatment</div>
                </div>
              </div>
              <div class="card my-2 shadow">
                <div class="card-body lead row">
                  ...
                  <div className="col-11">Bath or Clean Pets</div>
                </div>
              </div>
              <div class="card my-2 shadow">
                <div class="card-body lead row">
                  ...
                  <div className="col-11">1 Diaper per Day/Stay</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 text-end">
              <div className="container">
                <h4>Pet Boarding Requirements</h4>
                <h1 class="display-4 fw-bold lh-1">
                  <span className="yuki-font-color">The things you</span>
                  <br />
                  need to comply.
                </h1>
                <p class="lead">
        ...
        <div class="row flex-lg-row align-items-center g-5 pb-5">
          <div class="col-10 col-sm-8 col-lg-6">
            ...
            <h1 class="display-5 fw-bold lh-1 mb-3 yuki-font-color">
              Meet Our Team
              <br />
              <span className="black-font">Of True Pet Lovers</span>
            </h1>
            <p class="lead">
              Our staff spends time interacting with and monitoring the pets to
              ensure their safety and happiness while they are with us.
        ...
        <div class="px-4 py-3 my-5 text-center">
          ...
          <div class="col-lg-12 mx-auto">
            ...
            >
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p className="black-font">
                        "Yukimito had a pawsitively delightful stay at
                        Purrfection Pet Hotel! The staff showered her with love
                        and attention, and we were impressed by the cozy
                        accommodations. Five-star service for our fur baby!"
                      </p>
                    </div>
                  </div>
                </div>
                <div class="carousel-item active pt-3">
                  ...
                  <div className="container">
                    <div className="carousel-caption">
                      <h1 className="black-font">
                        Alessandra Santos Dela Rosa
                      </h1>
                      <div className="ratings pb-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <span
                  class="carousel-control-prev-icon black-font"
                  aria-hidden="true"
                ></span>
                <span class="visually-hidden">Previous</span>
              </button>
              ...
              >
                <span
                  class="carousel-control-next-icon black-font"
                  aria-hidden="true"
                ></span>
                <span class="visually-hidden">Next</span>
              </button>
