    ...
    <>
      <div className="shadow-lg yuki-color footer mt-5">
        ...
        <div class="container-fluid yuki-color">
          ...
          <footer class="d-flex flex-wrap justify-content-between align-items-center py-2 mt-1 border-top">
            <p class="col-md-5 text-muted dark-b-font">
              © 2024 QUALISOFT Solutions. All rights reserved.
            </p>

            <ul class="nav col-md-3 justify-content-end">
              <li class="nav-item"><a href="/" className="nav-link px-2 text-muted dark-b-font">
